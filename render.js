const I18N={"zh-CN":{allNormal:"系统一切正常",partialDown:"部分服务故障",allDown:"全部服务离线",lastUpdated:"最后更新于",secondsAgo:"{n}秒前",minutesAgo:"{n}分钟前",hoursAgo:"{n}小时前",online:"在线",uptime:"可用率",responseTime:"响应时间",sslExpiry:"SSL 剩余",days:"天",operational:"正常运行",degraded:"性能降级",down:"服务离线",serviceStatus:"服务状态总览",autoRefresh:"每60秒自动刷新",poweredBy:"基于 GitHub Actions 静态检测",loading:"加载中...",errorLoad:"数据加载失败",noData:"暂无数据",ms:"ms"},"zh-TW":{allNormal:"系統一切正常",partialDown:"部分服務故障",allDown:"全部服務離線",lastUpdated:"最後更新於",secondsAgo:"{n}秒前",minutesAgo:"{n}分鐘前",hoursAgo:"{n}小時前",online:"在線",uptime:"可用率",responseTime:"回應時間",sslExpiry:"SSL 剩餘",days:"天",operational:"正常運行",degraded:"效能降級",down:"服務離線",serviceStatus:"服務狀態總覽",autoRefresh:"每60秒自動重新整理",poweredBy:"基於 GitHub Actions 靜態偵測",loading:"載入中...",errorLoad:"資料載入失敗",noData:"暫無資料",ms:"ms"},"en-US":{allNormal:"All Systems Operational",partialDown:"Partial Outage",allDown:"All Systems Down",lastUpdated:"Last updated",secondsAgo:"{n}s ago",minutesAgo:"{n}m ago",hoursAgo:"{n}h ago",online:"online",uptime:"Uptime",responseTime:"Response",sslExpiry:"SSL",days:"days",operational:"Operational",degraded:"Degraded",down:"Down",serviceStatus:"Service Status",autoRefresh:"Auto-refresh 60s",poweredBy:"Powered by GitHub Actions",loading:"Loading...",errorLoad:"Failed to load",noData:"No data",ms:"ms"},"ja-JP":{allNormal:"全システム正常",partialDown:"一部障害",allDown:"全サービス停止",lastUpdated:"最終更新",secondsAgo:"{n}秒前",minutesAgo:"{n}分前",hoursAgo:"{n}時間前",online:"オンライン",uptime:"稼働率",responseTime:"レスポンス",sslExpiry:"SSL 残り",days:"日",operational:"正常",degraded:"低下",down:"停止",serviceStatus:"サービス一覧",autoRefresh:"60秒自動更新",poweredBy:"GitHub Actions 監視",loading:"読み込み中...",errorLoad:"読み込み失敗",noData:"データなし",ms:"ms"},"ko-KR":{allNormal:"모든 시스템 정상",partialDown:"일부 장애",allDown:"모든 서비스 중단",lastUpdated:"마지막 업데이트",secondsAgo:"{n}초 전",minutesAgo:"{n}분 전",hoursAgo:"{n}시간 전",online:"온라인",uptime:"가동률",responseTime:"응답",sslExpiry:"SSL 남은",days:"일",operational:"정상",degraded:"저하",down:"중단",serviceStatus:"서비스 현황",autoRefresh:"60초 자동 새로고침",poweredBy:"GitHub Actions 모니터링",loading:"로딩...",errorLoad:"로딩 실패",noData:"데이터 없음",ms:"ms"}};

let lang="zh-CN",statusData=null,historyData=null,timer=null,dark=false;

function detectLang(){const s=localStorage.getItem("sl");if(s&&I18N[s])return s;const b=navigator.language||"zh-CN";if(I18N[b])return b;const p=b.split("-")[0];for(const k of Object.I18N)if(k.startsWith(p))return k;return"zh-CN"}
